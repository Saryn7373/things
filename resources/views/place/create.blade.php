    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="h3 mb-0">Новое место хранения</h1>
                ...
                <div class="card-body p-4 p-md-5">
                    <form method="POST" action="{{ route('place.store') }}">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="repair" id="repair" {{ old('repair') ? 'checked' : '' }}>
                                    <label class="form-check-label" for="repair">Сейчас в ремонте / мойке</label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="work" id="work" {{ old('work', true) ? 'checked' : '' }}>
                        ...
                        <div class="d-grid d-md-block mt-5">
                            <button type="submit" class="btn btn-primary btn-lg px-5">Создать место</button>
